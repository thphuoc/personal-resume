  ...
  <section className="resume-section p-3 p-lg-5 d-flex d-column" id="about">
    <div className="my-auto">
      ...
      <p className="mb-5" style={{width: 1000, textAlign: 'justify'}}>
        ...
        1 year work Freelancer (In that duration have a few months work for VPBank) then back to FPT again with the role is Solution Architecture and work ODC at customer side is CBA (A software development HUB belong Commonwealth Bank) from 03/2016 until now.
